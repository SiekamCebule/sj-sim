...
void JumperFormGenerator::generateJumperFormTendence()
{
    ...
    double deviation = 4.20 + ((settings.getTendenceVariability() - 5) / 1.190);//1.666666666666667);
    ...
    double divider = 1 + (abs(oldTendence + random - 0) / 4.35);
...
void JumperFormGenerator::generateJumperForm()
{
    ...
    double divider = 1 + (distanceFromAverage / 8);
