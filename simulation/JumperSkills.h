...
{
public:
    JumperSkills(short takeoffPower = 0, short takeoffTechnique = 0, short flightStyle = 0, short flightTechnique = 0, short landingStyle = 0, const QSet<QString> &characteristics = QSet<QString>(), Jumper * jumper = nullptr);
